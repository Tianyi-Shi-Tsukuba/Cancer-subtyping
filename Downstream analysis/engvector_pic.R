...
plot(x = ev$vectors[,36],y = ev$vectors[,64],
     type = 'p',
     xlab = "eigenvector 36",
     ylab = "eigenvector 64",             
     main = "Cluster 1",
...
plot(L1[1:100],type="l",main="L1 norms in cluster2",xlab="Eigenvector index",ylab="L1 norm",col=c("red","blue","pink"))



write.csv(ev$vectors[,64]>0.2,"ev30.csv")
...
plot(data1,type="l",main="绘点线",xlab="x轴",ylab="y轴",col=c("red","blue","pink"))
