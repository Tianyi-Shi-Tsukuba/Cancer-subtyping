...
plot(x = ev$vectors[,22],y = ev$vectors[,30],
     type = 'p',
     xlab = "eigenvector 22",
     ylab = "eigenvector 30",             
     main = "Cluster 3",
...
plot(L1[1:100],type="l",main="L1 norms in cluster3",xlab="Eigenvector index",ylab="L1 norm",col=c("red","blue","pink"))

write.csv(ev$vectors[,30]>0.3,"ev30.csv")
